...
## 3. Pass forward, per favored team
- Its **proven starters** (started recent WC games).
- Its **goal/assist producers** and its **main star / penalty taker**.
- Anyone **reported injured or suspended** for today (exclude them).

Use only Kalshi, Polymarket, Forebet, The Guardian, Sports Mole. If a fixture has no data, mark it board-only. Never invent a lineup, stat, or scoreline.
